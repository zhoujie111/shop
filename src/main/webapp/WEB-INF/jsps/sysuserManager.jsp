...
<head>
    ...
    <script>
        ...
        function addSysuser(){
            $.post(
                '<%=request.getContextPath()%>/backend/sysuser/add',
                ...
                function(result){
                    if(result.status==1){
                        layer.msg('添加成功',{
                            ...
                            location.href='<%=request.getContextPath()%>/backend/sysuser/findAll?pageNum='+${pageInfo.pageNum};
                        })
                    }
        ...
        function modifyStatus(id,btn){
            $.post(
                '<%=request.getContextPath()%>/backend/sysuser/modifyStatus',
                {'id':id},
                function(result){
                    if(result.status==1){
...
<div class="panel panel-default" id="adminSet">
    ...
    <div class="panel-body">
        <div class="showmargersearch">
            <form class="form-inline" action="<%=request.getContextPath()%>/backend/sysuser/findByParams" method="post" id="frmSearch">
