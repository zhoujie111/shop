...
<head>
    ...
    <script type="text/javascript">
       //验证码看不清验证
        ...
        $(function () {
            console.log("打开页面后，执行之一句话$(function(){...})")
...
<div class="container div-signin">
    <div class="panel panel-primary div-shadow">
        ...
        <div class="panel-body">
            <!-- login form start -->
            <form action="<%=request.getContextPath()%>/backend/sysuser/login" class="form-horizontal" method="post" id="frmLogin">
